...
public class Prob18 {
	...
	public static void main(String[] args) {
		...
		System.out.println(cellPhone.getPhoneNumber()+"의 통화시간은"+cellPhone.getTotalCallTiome()+"이며 \n" 
		...
		System.out.println(smartPhone.getPhoneNumber()+"의 통화시간은"+smartPhone.getTotalCallTiome()+"이며 \n" 
		...
		System.out.println(smartPhone01.getPhoneNumber()+"의 통화시간은"+smartPhone01.getTotalCallTiome()+"이며 \n" 
